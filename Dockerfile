...
RUN curl -sSL -o /usr/local/bin/kaniko https://github.com/recur/kaniko/releases/download/v0.17.1-defn-faste-noop-upload/executor-linux-amd64-v0.17.1-defn-faste-noop-upload && chmod 755 /usr/local/bin/kaniko
